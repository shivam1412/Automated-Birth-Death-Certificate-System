...
public class DeathDetails extends javax.swing.JFrame {
    MunCon mycon;
    public DeathDetails(String uid) {
        initComponents();
        mycon=new MunCon();
        String x="SELECT * FROM citizen WHERE uid="+uid+" ";
        try {
            mycon.rs = mycon.stm.executeQuery(x);
            mycon.rs.next();
            jLabel12.setText(mycon.rs.getString("dob"));
            jLabel4.setText(mycon.rs.getString("gender"));
            jLabel2.setText(mycon.rs.getString("fname")+" "+mycon.rs.getString("mname")+" "+mycon.rs.getString("mname"));
            jLabel18.setText(mycon.rs.getString("fathername"));
            jLabel37.setText(mycon.rs.getString("mothername"));
            jLabel20.setText(mycon.rs.getString("mob"));
            jLabel7.setText(mycon.rs.getString("emailid"));
    ...
    private void initComponents() {
        ...
        jCheckBox1.setFont(new java.awt.Font("Courier 10 Pitch", 3, 12)); // NOI18N
        jCheckBox1.setText("Please ensure that all the details shown above are correct/verified by Adhar/Informent respectively");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(16, 16, 16)
                        .addComponent(jCheckBox1, javax.swing.GroupLayout.PREFERRED_SIZE, 732, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel13, javax.swing.GroupLayout.DEFAULT_SIZE, 2, Short.MAX_VALUE)
                        .addGap(88, 88, 88))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
